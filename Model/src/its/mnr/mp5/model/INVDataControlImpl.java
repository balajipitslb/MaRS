...
import its.mnr.mp5.vo.invoice.MrltInvoicexmlfeedViewImpl;
...
public class INVDataControlImpl extends ExtendedApplicationModuleImpl implements INVDataControl {
    ...
    public void executeInvoiceAssemblySearch() {
        ...
        if (existingRows != null || existingRows.length > 0) {
            ...
            whereClause.append("\n EVT.EVT_CODE = ACT.ACT_EVENT").append("\n AND  EVT.EVT_CODE= PAR.MTL_EVENT(+)").append("\n AND EVT.ITS_ISADF='Y'").append("\n AND EVT.EVT_STATUS = 'C'").append("\n AND EVT.EVT_COSTCODE= T_TAX_PERC.ACCTNUM(+)").append("\n AND EVT.EVT_CODE = T_TAX_PERC.EVT_CODE(+)");
    ...
    public void executeInvoiceCreditSearch() {
        ...
        try {
            ...
            if (existingRows != null || existingRows.length > 0) {
                ...
                whereClause.append("\n H.INVOICEHEADERID=I.INVOICEHEADERID").append("\n AND H.STATUS ='ISSUED'").append("\n AND H.TYPE='STD'");
    ...
    public void executeInvoiceRetroSearch() {
        ...
        if (existingRows != null || existingRows.length > 0) {
            ...
            whereClause.append("\n H.INVOICEHEADERID=I.INVOICEHEADERID").append("\n AND I.WO = ACT.ACT_EVENT").append("\n AND ART.ACCOUNTRATEID = A.ACCOUNTRATEID ").append("\n AND ART.TASKID = ITS_TASKID").append("\n AND H.ACCTNUM = A.ACCTNUM").append("\n AND A.ACCOUNTRATEID =  (SELECT MAX(TO_NUMBER(B.ACCOUNTRATEID)) FROM MRLT_ACCOUNTRATE B WHERE I.COMPLETEDT >=  B.EFFECTIVEDT AND B.ACCTNUM=A.ACCTNUM)").append("\n AND H.STATUS ='ISSUED'").append("\n AND H.TYPE = 'STD'")
            ...
            if (criteriaRow.getStartDt() != null && criteriaRow.getEndDt() != null) {
                whereClause.append("\n AND I.COMPLETEDT BETWEEN TO_DATE('" + criteriaRow.getStartDt() +
                                   "','rrrr/mm/dd') AND TO_DATE('" + criteriaRow.getEndDt() + "','rrrr/mm/dd') + 1");
    ...
    public void selectAllUnprocessedInvs() {
        deselectAllInvs();
        ViewObjectImpl vo = getMrltInvoicexmlfeedView();
        ...
        if (rsi != null) {
            ...
            while (rsi.hasNext()) {
                ...
                if (r.getAttribute("Isprocessed").equals("Y")) {
                    System.out.println("Inside removeProcessed processed Invnum: " + r.getAttribute("Invnum"));
                    r.remove();
                }
    ...
    /**
     * Container's getter for MrltInvoicexmlfeedView1.
     * @return MrltInvoicexmlfeedView1
     */
    public MrltInvoicexmlfeedViewImpl getMrltInvoicexmlfeedView() {
        return (MrltInvoicexmlfeedViewImpl) findViewObject("MrltInvoicexmlfeedView");
    }
