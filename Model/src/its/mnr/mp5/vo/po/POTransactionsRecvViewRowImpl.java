...
import its.mnr.mp5.vo.invoice.MrltInvoicertroitemViewRowImpl;
...
// ---    Mon Jan 13 13:47:42 PST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class POTransactionsRecvViewRowImpl extends ExtendedViewRowImpl implements POTransactionsRecvViewRow {
    ...
    public void fetchOrderlines_ORIG() {
        ////System.out.println("fetchOrderlines()");
        Integer cnt = 0;
//        Boolean notRecvdYet = false;
//        Boolean partialRecvd = false;
        R5transactionsImpl implTrans = getR5transactions();
        //        implTrans.fetchOrderlines();
        R5ordersImpl implOrd = implTrans.getR5orders();
        RowSet rs = (RowSet)implOrd.getR5orderlines();
        ...
        if (rs.first() != null) {
            Row rw = rs.first();
            sOrder = (String)rw.getAttribute("OrlOrder");
            sOrdLine = (Integer)rw.getAttribute("OrlOrdline");
            sPart = (String)rw.getAttribute("OrlPart");
            sPartOrg = (String)rw.getAttribute("OrlPartOrg");
            sStatus = (String)rw.getAttribute("OrlStatus");
            sOrdLineType = (String)rw.getAttribute("ItsOrltype");
            dOrderedQty = (Double)rw.getAttribute("OrlOrdqty");
            ...
            if (/*notRecvdYet &&*/ (dRecvdQty.compareTo(dOrderedQty) < 0) && "A".equals(sStatus) && "PART".equals(sOrdLineType)) {
                ...
                ////System.out.println("1 rowImpl.gettOutstanding(): " + rowImpl.gettOutstanding());
                rowImpl.setTrlType("RECV");
                rowImpl.setTrlRtype("RECV");
                rowImpl.setTrlPart(sPart);
                rowImpl.setTrlOrdline(sOrdLine);
                rowImpl.setTrlLot(sLot);
                rowImpl.setTrlBin(sBin);
                rowImpl.setTrlStore((String)rw.getAttribute("OrlStore"));
                rowImpl.setTrlPrice((Double)rw.getAttribute("OrlPrice"));
                rowImpl.setTrlOrder(sOrder);
                rowImpl.setTrlIo(1);
                rowImpl.setTrlOrderOrg((String)rw.getAttribute("OrlOrderOrg"));
                rowImpl.setTrlPartOrg(sPartOrg);
                rowImpl.setTrlQty((Double)rowImpl.gettOutstanding());
               // //System.out.println("1 rowImpl.gettOutstanding(): " + rowImpl.gettOutstanding());
            }
        }
        while (rs.hasNext()) {
            ...
            if (rw != null && (/*notRecvdYet  &&*/ (dRecvdQty.compareTo(dOrderedQty) < 0) && "A".equals(sStatus) && "PART".equals(sOrdLineType))) {
                ...
                rowImpl.setTrlRtype("RECV");
                rowImpl.setTrlPart(sPart);
                rowImpl.setTrlOrdline((Integer)rw.getAttribute("OrlOrdline"));
                rowImpl.setTrlLot(sLot);
                rowImpl.setTrlBin(sBin);
                rowImpl.setTrlStore((String)rw.getAttribute("OrlStore"));
                rowImpl.setTrlPrice((Double)rw.getAttribute("OrlPrice"));
                rowImpl.setTrlOrder((String)rw.getAttribute("OrlOrder"));
                rowImpl.setTrlIo(1);
                rowImpl.setTrlOrderOrg((String)rw.getAttribute("OrlOrderOrg"));
                rowImpl.setTrlPartOrg(sPartOrg);
                rowImpl.setTrlQty((Double)rowImpl.gettOutstanding()); 
    ...
    //        Boolean partialRecvd = false;
        ...
        //        implTrans.fetchOrderlines();
        //R5ordersImpl implOrd = implTrans.getR5orders();
        POrdersViewRowImpl impl = (POrdersViewRowImpl)getPOrdersView();
        //RowSet rs = (RowSet)implOrd.getR5orderlines();
        RowIterator ritOrl = impl.getPOrderlinesView();
        //Get rows already received
        ArrayList<Integer> aList = ordLinesFetched();
        Integer sOrdLine;
        RowIterator rit = getPOTranslinesView();
        ...
        if (ritOrl.first() != null) {
            ...
            if ("PART".equals(sOrdLineType)) {
                dOrderedQty = (Double)rw.getAttribute("OrlOrdqty");
            }else if ("SERVICE".equals(sOrdLineType)) {
                dOrderedQty = (Double)rw.getAttribute("OrlTaskqty");
            }
...
//        ritOrl.closeRowSet();
    ...
    public enum AttributesEnum {
        TraAcd {
            public Object get(POTransactionsRecvViewRowImpl obj) {
                return obj.getTraAcd();
            }

            public void put(POTransactionsRecvViewRowImpl obj, Object value) {
        ...
        POTranslinesViewRS {
            public Object get(POTransactionsRecvViewRowImpl obj) {
                return obj.getPOTranslinesViewRS();
            }
        ...
        public abstract Object get(POTransactionsRecvViewRowImpl object);

        public abstract void put(POTransactionsRecvViewRowImpl object, Object value);
    ...
    public static final int POTRANSLINESVIEWRS = AttributesEnum.POTranslinesViewRS.index();

    /**
     * This is the default constructor (do not remove).
     */
    public POTransactionsRecvViewRowImpl() {
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> POTransactionsRecvView.
     */
    public RowSet getPOTransactionsRecvView() {
        return (RowSet)getAttributeInternal(POTRANSACTIONSRECVVIEW);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> POTranslinesViewRS.
     */
    public RowSet getPOTranslinesViewRS() {
        return (RowSet)getAttributeInternal(POTRANSLINESVIEWRS);
    }
